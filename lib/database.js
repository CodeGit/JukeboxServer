...
db.pushItemUpQueue = function(musicId, callback) {
    console.log("Pushing " + musicId + " up queue");
}

db.pushItemDownQueue = function(musicId, callback) {
    console.log("Pushing " + musicId + " cookie queue");
}
...
/*
db.updateUser = function(cookie, tokens, callback) {
    var query = db.User.findOneAndUpdate(
        {
            cookie:cookie
        },
        {
